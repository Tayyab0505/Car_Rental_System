            ...
            <div className="w-full max-w-4xl flex rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="flex-1 bg-white dark:bg-slate-800 flex flex-col justify-center px-6 py-10 md:px-10 md:py-12">
                    ...
                    <div className="flex bg-slate-100 dark:bg-slate-700 rounded-xl p-1 mb-8">
                        ...
                        <Link to="/register" className="flex-1 text-center py-2 text-slate-500 dark:text-slate-400 text-sm hover:text-slate-700 dark:hover:text-slate-200 transition-colors" style={{ fontFamily: 'Outfit,sans-serif' }}>
                            Create account
                        </Link>
                    </div>

                    <h2 className="text-2xl font-semibold text-slate-800 dark:text-slate-100 mb-1" style={{ fontFamily: 'Outfit,sans-serif' }}>Welcome back</h2>
                    <p className="text-slate-500 dark:text-slate-400 text-sm mb-7">Enter your credentials to access your account</p>
                    ...
                    <p className="text-center text-xs text-slate-400 dark:text-slate-500 mt-6">
                        ...
                        <Link to="/register" className="text-blue-600 dark:text-blue-400 hover:underline font-medium">Create one</Link>
                    </p>
                </div>
            </div>
        </div>
